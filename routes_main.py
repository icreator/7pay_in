...
#
default_application = 'shop'    # ordinarily set in base routes.py
...
routes_app = [
# LITE.cash/bets
    #(r'.*?:https?://lite.cash/bets:\w* /$anything', r'bets'),
    #(r'.*?:https?://www.lite.cash/bets:\w* /$anything', r'bets'), # (www.)? - ???
# LITE.cash
    (r'.*?:https?://lite.cash:\w* /$anything', r'bs3b'),
    (r'.*?:https?://www.lite.cash:\w* /$anything', r'bs3b'), # (www.)? - ???
# wagers.win
    (r'.*?:https?://wagers.win:\w* /$anything', r'bets'),
    (r'.*?:https?://www.wagers.win:\w* /$anything', r'bets'), # (www.)? - ???
# wagers.world
    (r'.*?:https?://wagers.world:\w* /$anything', r'bets'),
    (r'.*?:https?://www.wagers.world:\w* /$anything', r'bets'), # (www.)? - ???
# cryptoPay.in
    (r'.*?:https?://cryptopay.in:\w* /$anything', r'shop'),
    (r'.*?:https?://www.cryptopay.in:\w* /$anything', r'shop'),
# admin    (r'(.+)admin/$anything', r'admin'), # worked!
