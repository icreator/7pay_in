...
def get_uri_in():
    ...
    _, uri = common.uri_make(curr_in.name2, addr_in,
                             {'amount': vol_in, 'label': db_client.make_x_acc_label(deal, addr_out, curr_out_abbrev)})
...
def get_uri():
    ...
    _, uri = common.uri_make(curr_in.name2, addr_in, {'amount': volume_in,
